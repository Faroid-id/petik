...
<html lang="en">
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
    ...
    <div class="container">
    <br><br><br>
        <div class="container"><h1><b>Pesanan Saya</b></h1></div>
        <br>
      <div class="container">
				<div class="media">
...
require_once "koneksi.php";
      ...
      $data = mysqli_query($koneksi,"SELECT 05_pesanan.* FROM 05_pesanan, 05_users WHERE 05_pesanan.email_user=05_users.email AND 05_users.email='$email'");
      while($d = mysqli_fetch_array($data)){
          $id=$d['id'];
                        $decode=$d['detail_barang'];
              $decode=base64_decode($decode);
              echo "<a style=\"margin:20px;\" href=\"detail_pesanan.php?id=$id\">
